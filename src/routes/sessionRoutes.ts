...
export default function sessionRoutes(prisma: PrismaClient) {
  ...
  router.get('/:id/combat/capabilities', sessionController.getCombatCapabilities.bind(sessionController));
  ...
  router.post('/:id/initiative/roll-characters', sessionController.rollInitiativeCharacters.bind(sessionController));
  ...
  router.post('/:id/combat/execute-capability', sessionController.executeCombatCapability.bind(sessionController));
  ...
  router.delete('/:sessionId/characters/:characterId/effects/:effectId', sessionController.removeEffect.bind(sessionController));
  router.delete('/:sessionId/monsters/:monsterId/effects/:effectId', sessionController.removeMonsterEffect.bind(sessionController));
